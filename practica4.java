...
public class practica4 extends JFrame implements KeyListener {
    ...
    public void dibujarCubo(int puntos[][], int cam[], Color c){
        ...
        dibujarLinea(transformar2D[0][0], transformar2D[0][1], transformar2D[4][0], transformar2D[4][1], Color.black);
        dibujarLinea(transformar2D[1][0], transformar2D[1][1], transformar2D[5][0], transformar2D[5][1], Color.black);
        dibujarLinea(transformar2D[2][0], transformar2D[2][1], transformar2D[6][0], transformar2D[6][1], Color.black);
        dibujarLinea(transformar2D[3][0], transformar2D[3][1], transformar2D[7][0], transformar2D[7][1], Color.black);
