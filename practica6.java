...
public class practica6 extends JFrame implements KeyListener, Runnable{
    ...
    public void run() {
        while (true) {
            ...
            if(cambio==false){
            rotacion[0] = rotacion[0] + Math.PI/90;
            rotacion[1] = rotacion[1] + Math.PI/90;
            rotacion[2] = rotacion[2] + Math.PI/90;
            }else if(cambio=true){
            rotacion[0] = rotacion[0] - Math.PI/90;
            rotacion[1] = rotacion[1] - Math.PI/90;
            rotacion[2] = rotacion[2] - Math.PI/90;
